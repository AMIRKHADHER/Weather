...
import 'package:weather/domain/usecases/get_five_day_forecast_use_case.dart';
...
Future<void> init() async {
  ...
  //! Bloc
  sl.registerFactory(
    () => WeatherBloc(getFiveDayForecastUseCase: sl()),
  );

  //! Use cases
  sl.registerLazySingleton(
      () => GetFiveDayForecastUseCase(weatherRepository: sl()));
